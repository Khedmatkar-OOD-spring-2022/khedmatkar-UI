        ...
        <Row className="d-flex justify-content-center">
          ...
          >
            <Card style={{ width: "20%" }}>
              <Card.Img
                variant="top"
                src="https://thecleaningcrew.ie/wp-content/uploads/2020/09/cleaning-crew-cleaners.png"
                style={{ width: "50%" }}
              />
              <Card.Body>
            ...
            <Card>
              <Card.Img
                variant="top"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRd_v2j-kOBKR54WZzxuGBMM__hgRLJK20v-w&usqp=CAU"
                style={{ width: "50%" }}
              />
              <Card.Body>
            ...
            <Card>
              <Card.Img
                variant="top"
                src="https://previews.123rf.com/images/vector2011/vector20111704/vector2011170400034/75830838-friendly-technician-installer-of-solar-panels-he-wears-a-belt-with-tools.jpg"
                style={{ width: "50%" }}
              />
              <Card.Body>
